    ...
    public static class AdminDatabaseManager
    {
        ...
        */
        ...
        public static void CreateBarsTable(string symbol, string tableType)
        {
            ...
            sql += "`cdOpen` FLOAT(9,6) NULL DEFAULT NULL,";
            sql += "`cdHigh` FLOAT(9,6) NULL DEFAULT NULL,";
            sql += "`cdLow` FLOAT(9,6) NULL DEFAULT NULL,";
            sql += "`cdClose` FLOAT(9,6) NULL DEFAULT NULL,";
            ...
            sql += "`cdAvg` FLOAT(9,6) NULL DEFAULT NULL,";
            ...
            sql += "`cdHLC3` FLOAT(9,6) NULL DEFAULT NULL,";
            sql += "`cdMid` FLOAT(9,6) NULL DEFAULT NULL,";
            sql += "`cdOpenInterest` INT(11) NULL DEFAULT NULL,";
            sql += "`cdRange` CHAR(30) NULL DEFAULT NULL,";
            sql += "`cdTrueHigh` FLOAT(9,6) NULL DEFAULT NULL,";
            sql += "`cdTrueLow` FLOAT(9,6) NULL DEFAULT NULL,";
            sql += "`cdTrueRange` FLOAT(9,6) NULL DEFAULT NULL,";
